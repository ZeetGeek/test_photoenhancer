...
export const PrivacyPolicy = () => {
    return (
        <>
            ...
            <section className={`privacy-policy-gl`}>
                <Container>
                    <Row>
                        <Col lg={12}>
                            <div>
                                <h1 className="text-center h1_title main-title">Privacy Policy</h1>
                            </div>
                            <div>
                                <p>
                                ...
                                <h2 className="h3_title title">Interpretation and Definitions</h2>
                                <h3 className="h4_title sub-title">Interpretation</h3>
                                <p>
                                ...
                                <h3 className="h4_title sub-title">Definitions</h3>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        where &quote;control&quote; means ownership of 50% or more
                                        of the shares, equity interest, or other securities entitled
                                        to vote for the election of directors or other managing
                                        authority.
                                    </li>
                                    <li>
                                        <strong>Application:</strong> Refers to Photo Enhancer, the
                                        software program provided by the Company.
                                    </li>
                                    <li>
                                        <strong>Company:</strong> Referred to as either &quote;the
                                        Company,&quote; &quote;We,&quote; &quote;Us,&quote; or
                                        &quote;Our&quote; in this Agreement. It specifically refers
                                        to Photo Enhancer.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        the Company to facilitate the Service, provide the Service
                                        on behalf of the Company, perform services related to the
                                        Service, or assist the Company in analyzing how the Service
                                        is used.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <strong>Website </strong> refers to Photo Enhancer,
                                        accessible from{" "}
                                        <Link href="https://photoenhancer.app/" target="_blank">
                                ...
                                <h3 className="sub-title">Tracking Technologies and Cookies</h3>
                                ...
                                <p>
                                    <strong>
                                        Cookies can be &quote;Persistent&quote; or
                                        &quote;Session&quote; Cookies:
                                    </strong>{" "}
                                ...
                                <ul>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <strong>Purpose:</strong> These Cookies identify if
                                ...
                                <p>
                                    ...
                                    <a href="link-to-cookies-policy">Cookies Policy</a> or the
                                    Cookies section of our{" "}
                                    <a href="link-to-privacy-policy">Privacy Policy</a>.
                                </p>

                                <h3 className="sub-title">Use of Your Personal Data</h3>
                                ...
                                <h3 className="sub-title">Retention of Your Personal Data</h3>
                                ...
                                <h3 className="sub-title">Transfer of Your Personal Data</h3>
                                ...
                                <h3 className="sub-title">Delete Your Personal Data</h3>
                                ...
                                <h3 className="sub-title">Disclosure of Your Personal Data</h3>
                                ...
                                <h3 className="sub-title">Security of Your Personal Data</h3>
                                ...
                                <h2 className="title">Links to Other Websites</h2>
                                ...
                                <p>
                                    ...
                                    &quote;Last updated&quote; date at the top of this Privacy
                                    Policy.
                                </p>
